 ...
 *
 * GLOBALISE twin of `rijksmuseum-mcp-plus/src/overlay-compositor.ts`. Plan 020
 * ported the pixel-dimensions reader; plan 021 ports the rest — the
 * `show_overlays` SVG compositor that draws the model's active overlays onto a
 * returned crop for visual verification.
 */
